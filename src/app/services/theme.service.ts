...
//           this.setGlobalCSS(cssText);
//           this.storage.get('name').then(name => {
//             console.log("storage theme service");
//             resolve(name);
//           });
//         }
//         else {
//           resolve(undefined);
//           console.log("storage theme service resolved else");
//         }
//       });
//     })
//   }
...
//     this.setGlobalCSS(cssText);
//     if (name != 'undefined') {
//       console.log("not undefined theme service"+name);
//       this.storage.set('name', name);
//       this.storage.set('theme', cssText);
//     }
//   }
...
//   private setGlobalCSS(css: string) {
//     console.log("set global scss");
//     this.document.documentElement.style.cssText = css;
//   }

//   get storedTheme() {
//     console.log("get stored theme");
