...
export class ProductsPage implements OnInit {
  ...
  constructor(public menuCtrl: MenuController,
    ...
    setTimeout(() => {
      this.products = [
        ...
        { sale: true, featured: false, img: "assets/images/item-images/5.jpg", name: "Denim Jacket", price: "14.64", dPrice: "20.00", fav: false, res: true },
        { sale: false, featured: true, img: "assets/images/item-images/2.jpg", name: "Shoulder Top", price: "15.36", dPrice: "25.00", fav: false, res: true },
      ]
    }, 5000);
  ...
  loadData(event) {
    setTimeout(() => {
      console.log(event);
      this.products.push({ img: "assets/images/item-images/1.jpg", name: "Printed Cotton Tshirt", price: "14.64", dPrice: "11.00", fav: true , res: true},
        { img: "assets/images/item-images/2.jpg", name: "Shoulder Top", price: "12.23", dPrice: "11.00", fav: false, res: true }
      );
